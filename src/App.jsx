    ...
    <div className="min-h-screen bg-slate-100 font-sans text-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 h-[calc(100vh-4rem)]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-full">
          ...
          {/* Preview - Right Side */}
          <div className="lg:col-span-7 h-full bg-slate-200/50 rounded-xl border border-slate-200 overflow-y-auto p-4 flex justify-center items-start shadow-inner">
            {/* Scale container to fit if needed, but for now just scroll */}
            <div className="transform scale-[0.85] origin-top md:scale-95 lg:scale-100 transition-transform">
